<?php 
namespace App\classes\User\MailerManager\PHPMailer;
use App\classes\User\MailerManager\PHPMailer\vendor\PHPMailer\PHPMailer\PHPMailer;
    	...
    	public function sendMail($clientMail,$clientName,$message){
    		$mail = new PHPMailer(true);                              // Passing `true` enables exceptions
				try {
				    ...
				    $mail->Password = "Mugiwara20";                           // SMTP password
